package com.example.vaibhav.samplegame.components;
...
import com.example.vaibhav.samplegame.R;
...
public class GameView extends SurfaceView implements Runnable {
    ...
    private void update() {
        ...
        if (Rect.intersects(player.getDetectCollision(), enemy.getDetectCollision())) {
            ...
            if (flag) {
                //if player's x coordinate is equal to enemy's y coordinate
        ...
        if (Rect.intersects(enemy.getDetectCollision(), friend.getDetectCollision())) {

            friend.setY(friend.getY() + 400);
        }
